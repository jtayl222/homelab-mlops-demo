...
if [[ "$NAMESPACE" != "argowf" ]]; then
    ...
    echo "   kubectl port-forward -n $NAMESPACE svc/iris-0-2-0-default-classifier 9000:9000 &"
    echo "   curl -X POST http://localhost:9000/api/v1.0/predictions -H 'Content-Type: application/json' -d '{\"data\":{\"ndarray\":[[5.1,3.5,1.4,0.2]]}}'"
    echo ""
